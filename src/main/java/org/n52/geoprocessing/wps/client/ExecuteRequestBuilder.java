...
public class ExecuteRequestBuilder {
    ...
    public void addComplexData(String parameterID,
        ...
        LOGGER.debug("Looking for matching Generator ..." + " schema: " + schema + " mimeType: " + mimeType
                + " encoding: " + encoding);
    ...
    public boolean setAsReference(String outputName,
        ...
        for (DocumentOutputDefinitionType outputDefTemp : execute.getExecute().getResponseForm().getResponseDocument()
                .getOutputArray()) {
